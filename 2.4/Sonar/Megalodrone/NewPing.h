...
// Added support for Arduino DUE and other non-AVR microcontrollers like the 32 bit ARM Cortex-M4 based Teensy 3.1.
...
// Added TIMER_ENABLED switch to get around compile-time "__vector_7" errors when using the Tone library, or you can use the toneAC library (http://code.google.com/p/arduino-tone-ac).
